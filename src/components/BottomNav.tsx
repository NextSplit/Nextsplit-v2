...
const IconToday = (active: boolean) => (
...
const ATHLETE_TABS = [
  ...
  { href: '/profile',   label: 'Character', icon: IconCharacter },
]

// Coaches: Athletes tab in the middle — their primary workspace
const COACH_TABS = [
  { href: '/today',       label: 'Today',     icon: IconToday     },
  { href: '/plan',        label: 'Plan',      icon: IconPlan      },
  { href: '/coach/squad', label: 'Athletes',  icon: IconAthletes  },
  { href: '/community',   label: 'Community', icon: IconCommunity },
  { href: '/profile',     label: 'Character', icon: IconCharacter },
]
