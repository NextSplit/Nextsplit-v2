      ...
      >
        ...
        <div className="mb-5">
          <div className="flex justify-between items-center mb-2">
            ...
            <span className="text-2xl font-bold text-[var(--ns-forest)]">{effort}<span className="text-sm text-gray-400">/10</span></span>
          </div>
          <input
        ...
        <button
          ...
          className="flex items-center gap-2 text-xs font-semibold text-[var(--ns-forest)] mb-4"
        >
        ...
        <div className="mb-6">
          ...
          <textarea
            ...
            rows={2}
            className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm text-gray-900 placeholder:text-gray-400 resize-none focus:outline-none focus:ring-2 focus:ring-[var(--ns-forest)] focus:border-transparent"
          />
        </div>
          </>
        )}
