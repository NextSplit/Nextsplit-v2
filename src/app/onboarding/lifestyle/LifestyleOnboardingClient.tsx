  ...
  return (
    <div className="min-h-screen flex flex-col px-5 pt-14 pb-10" style={{ background: 'linear-gradient(160deg, #0f172a 0%, #18181b 60%, #0f172a 100%)' }}>
      ...
      {step === 'freq' && (
        <div>
          <div className="inline-flex items-center gap-1.5 bg-[var(--ns-ember)]/15 border border-[var(--ns-ember)]/30 rounded-full px-3 py-1 mb-6">
            <span className="text-xs font-bold text-[var(--ns-ember)]">{selectedFocus?.label} ✓</span>
          </div>
      ...
      {step === 'name' && (
        <div>
          <div className="inline-flex items-center gap-1.5 bg-[var(--ns-ember)]/15 border border-[var(--ns-ember)]/30 rounded-full px-3 py-1 mb-6">
            <span className="text-xs font-bold text-[var(--ns-ember)]">{selectedFocus?.label} · {freq} days/week ✓</span>
          </div>
