      ...
      <div className="max-w-2xl mx-auto px-6 py-12">
        ...
        <div className="prose prose-slate max-w-none space-y-8 text-sm leading-relaxed text-slate-700">
          ...
          <section>
            ...
            <p className="mt-2">Contact: <a href="mailto:privacy@nextsplit.com" className="text-teal-600 hover:underline">privacy@nextsplit.com</a></p>
          </section>
            ...
            <div className="space-y-2">
              {[
                ...
                <div key={s.name} className="flex gap-3">
                  <span className="text-teal-500 font-bold shrink-0">→</span>
                  <div><span className="font-semibold text-slate-800">{s.name}:</span> {s.purpose}. <a href={s.link} target="_blank" rel="noopener noreferrer" className="text-teal-600 hover:underline">Privacy policy</a></div>
                </div>
              ))}
            </div>
          ...
          <section>
            ...
            <p className="mt-2">To exercise any right not available in-app, email <a href="mailto:privacy@nextsplit.com" className="text-teal-600 hover:underline">privacy@nextsplit.com</a>. We will respond within 30 days.</p>
          </section>
          ...
          <section>
            ...
            <p>For privacy questions or to exercise your rights: <a href="mailto:privacy@nextsplit.com" className="text-teal-600 hover:underline">privacy@nextsplit.com</a></p>
          </section>
