...
function acwrColour(acwr: number | null) {
  if (acwr === null) return { text: 'text-[var(--color-text-tertiary)]', bg: 'bg-[var(--color-surface-2)]', label: '—' }
    ...
    <a href="/dashboard" className="block">
      <div className="bg-white rounded-2xl border border-[var(--color-border)] overflow-hidden">
        ...
        <div className="px-4 pt-3 pb-2 flex items-center justify-between">
          <p className="text-[11px] font-bold text-[var(--color-text-tertiary)] uppercase tracking-wider">This week</p>
        ...
        <div className="grid grid-cols-4 divide-x divide-[var(--color-border)] border-t border-[var(--color-border)]">
          ...
          <div className="px-3 py-3 text-center">
            ...
            <p className="text-[9px] text-[var(--color-text-tertiary)] font-medium">km</p>
          </div>

          {/* Sessions */}
          <div className="px-3 py-3 text-center">
            <p className="text-lg font-black text-gray-900">{sessionsDone}</p>
            <p className="text-[9px] text-[var(--color-text-tertiary)] font-medium">sessions</p>
          </div>
          ...
          <div className="px-3 py-3 text-center">
            ...
            <p className="text-[9px] text-[var(--color-text-tertiary)] font-medium">streak</p>
          </div>
          ...
          <div className="px-3 py-3 text-center">
            ...
            <p className="text-[9px] text-[var(--color-text-tertiary)] font-medium">load</p>
          </div>
        </div>

        {/* ACWR context bar — only if we have data */}
        {acwr !== null && (
          <div className={`px-4 py-2 flex items-center gap-2 border-t border-[var(--color-border)] ${acwrCfg.bg}`}>
        ...
        {avgEffort !== null && (
          <div className="px-4 py-2 border-t border-[var(--color-border)] flex items-center justify-between">
            <span className="text-[10px] text-[var(--color-text-tertiary)]">Avg effort this week</span>
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[10px] font-bold text-[var(--color-text-secondary)] ml-1">{avgEffort}/10</span>
            </div>
          </div>
        )}
      </div>
