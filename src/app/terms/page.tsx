  ...
  return (
    <main className="min-h-screen bg-white">
      <div className="max-w-2xl mx-auto px-6 py-12">
        ...
        <div className="mb-10">
          <Link href="/" className="text-teal-600 text-sm font-semibold hover:underline">← NextSplit</Link>
          <h1 className="text-3xl font-black text-slate-900 mt-4">Terms of Service</h1>
        ...
        <div className="prose prose-slate max-w-none space-y-8 text-sm leading-relaxed text-slate-700">
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900 mb-3">1. Agreement</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900 mb-3">2. The service</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900 mb-3">3. Account</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900 mb-3">4. Subscriptions and payments</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900 mb-3">5. Coach marketplace</h2>
            <div className="space-y-2">
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900 mb-3">6. AI coaching</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900 mb-3">7. Acceptable use</h2>
            <p>You must not:</p>
          ...
          <section>
            ...
            <p>Your use of NextSplit is also governed by our <Link href="/privacy" className="text-teal-600 hover:underline">Privacy Policy</Link>. You own your training data. We do not sell it. You can export or delete it at any time.</p>
          </section>
          ...
          <section>
            ...
            <p>Questions about these terms: <a href="mailto:legal@nextsplit.com" className="text-teal-600 hover:underline">legal@nextsplit.com</a></p>
          </section>
