  ...
  return (
    ...
    >
      <div className="text-center px-8 animate-card-up" onClick={e => e.stopPropagation()}>
        ...
        <div className="text-teal-300 text-lg font-bold mb-5">{rpgLevel?.name}</div>
        ...
        <button onClick={onDismiss}
          className="px-8 py-3 rounded-2xl bg-[#0D9488] text-white text-sm font-black animate-slide-up"
