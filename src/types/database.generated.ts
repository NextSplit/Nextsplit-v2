...
// Source of truth: live schema of project wlrmeiczqgmharvfmalq.
// Regenerate with: ./scripts/gen-types.sh (after S5 path fix).
//
// src/types/database.ts re-exports Database + Json from this file and
// keeps the hand-crafted derived helpers (Profile, PlanTemplate, UserPlan,
// CoachProfile, etc.) so existing imports across the codebase still resolve.
