...
// 02:00 UTC daily — K31 GDPR deletion cron. Scans profiles for
// deletion_requested_at older than 30 days and hard-deletes the
// auth user (cascading to every public.* row).
